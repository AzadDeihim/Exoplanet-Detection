...
The estimated completion time of the code is 25-45 minutes as the dataset is very
large. There are some parts of the code commented out, such as the tSNE
